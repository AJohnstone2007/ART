package uk.ac.rhul.cs.csle.art.alg.earleytable.indexedapi;
...
public class ARTEarleyTableIndexedAPI extends ARTParserBase {
  ...
  public ARTEarleyTableIndexedAPI(ARTGrammar artParserGrammar) throws ARTException {
  ...
  public void artParse(String stringInput, String inputFilename, boolean useRDNSet) throws ARTException {
    ...
    if (ARTTRACE) artTraceText = new ARTText(new ARTTextHandlerFile("EarleyParserTrace.txt"));
    ...
    int[] ret;
    ArrayList<ARTGrammarElementTerminal> input1 = new ARTLexerBase(earleyTableIndexed.getGrammar()).lexicaliseToArrayListOfTerminals(stringInput, 1);
    if (input1 == null)
      ret = null;
    else {
