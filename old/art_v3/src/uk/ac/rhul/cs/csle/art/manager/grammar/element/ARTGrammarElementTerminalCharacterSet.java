...
public class ARTGrammarElementTerminalCharacterSet extends ARTGrammarElementTerminal {
  ...
  public ARTGrammarElementTerminalCharacterSet(String lo, String hi) throws ARTException {
    super(null);
    if (lo.length() > 1) throw new ARTException("Internal error: character set lo bound string length > 1");
    if (hi.length() > 1) throw new ARTException("Internal error: character set hi bound string length > 1");
