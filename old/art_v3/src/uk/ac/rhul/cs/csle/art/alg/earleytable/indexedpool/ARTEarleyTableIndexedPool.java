package uk.ac.rhul.cs.csle.art.alg.earleytable.indexedpool;
...
public class ARTEarleyTableIndexedPool extends ARTParserBase {
  ...
  public ARTEarleyTableIndexedPool(ARTGrammar artGrammar) throws ARTException, FileNotFoundException {
    super(artGrammar);
