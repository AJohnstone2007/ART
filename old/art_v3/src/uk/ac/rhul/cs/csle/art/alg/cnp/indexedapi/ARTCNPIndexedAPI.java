package uk.ac.rhul.cs.csle.art.alg.cnp.indexedapi;
...
public class ARTCNPIndexedAPI extends ARTParserBase {
  ...
  void processEoC(int slot) throws ARTException {
  ...
  void processCat(int slot) throws ARTException {
    ...
    while (true) {
      ...
      if (artSlotArray.isTerminalSlot(leftSlot)) {
        ...
        throw new ARTException("Unexpected slot " + leftSlot + " in CNPTraverser");
