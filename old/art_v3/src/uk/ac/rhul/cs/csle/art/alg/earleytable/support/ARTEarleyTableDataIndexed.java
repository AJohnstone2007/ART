...
public class ARTEarleyTableDataIndexed {
  ...
  ARTEarleyTableDataIndexed(ARTEarleyTableDataLinked earleyTableLinked) throws ARTException {
  ...
  public ARTEarleyTableDataIndexed(ARTGrammar artGrammar) throws ARTException {
