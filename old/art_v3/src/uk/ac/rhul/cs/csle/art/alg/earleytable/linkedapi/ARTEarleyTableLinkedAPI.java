package uk.ac.rhul.cs.csle.art.alg.earleytable.linkedapi;

import java.util.ArrayList;
import java.util.Set;

import uk.ac.rhul.cs.csle.art.alg.ARTParserBase;
import uk.ac.rhul.cs.csle.art.alg.earleytable.support.ARTChiBSR;
import uk.ac.rhul.cs.csle.art.alg.earleytable.support.ARTChiBSRSet;
import uk.ac.rhul.cs.csle.art.alg.earleytable.support.ARTChiSet;
import uk.ac.rhul.cs.csle.art.alg.earleytable.support.ARTEarleyNFAVertex;
import uk.ac.rhul.cs.csle.art.alg.earleytable.support.ARTEarleyTableDataLinked;
...
public class ARTEarleyTableLinkedAPI extends ARTParserBase {
  ...
  public ARTEarleyTableLinkedAPI(ARTGrammar artParserGrammar) throws ARTException {
  ...
  public void artParse(String stringInput, String inputFilename, boolean useRDNSet) throws ARTException {
    if (ARTTRACE) artTraceText = new ARTText(new ARTTextHandlerFile("EarleyTableParserTrace.txt"));
    ...
    ArrayList<ARTGrammarElementTerminal> input = new ARTLexerBase(nfa.getGrammar()).lexicaliseToArrayListOfTerminals(stringInput, 1);
  ...
  public void artParse(String inputString) throws ARTException {
    throw new ARTException("No grammar supplied to " + this.getClass());
  }

  @Override
  public void artParse(String inputString, String nonterminalName) throws ARTException {
    artParse(inputString, nonterminalName, true);
  }
}
