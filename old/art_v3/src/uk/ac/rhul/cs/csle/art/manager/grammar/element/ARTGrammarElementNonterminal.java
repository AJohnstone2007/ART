...
import uk.ac.rhul.cs.csle.art.manager.grammar.ARTName;
...
public class ARTGrammarElementNonterminal extends ARTGrammarElement {
  ...
  public ARTGrammarElementNonterminal(ARTModule module, String id) {
    super();
    this.module = module;
    this.id = id;
  }
  ...
  public void setModule(ARTModule module) {
    this.module = module;
  }
