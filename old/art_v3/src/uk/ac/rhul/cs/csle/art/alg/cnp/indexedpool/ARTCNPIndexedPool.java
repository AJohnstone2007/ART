package uk.ac.rhul.cs.csle.art.alg.cnp.indexedpool;
...
public class ARTCNPIndexedPool extends ARTParserBase {
  ...
  protected void ntAddTemplate(int N, int i, int[] firstSlots) throws ARTException {
    if (ARTTRACE) artTraceText.println("ntAdd(" + artSlotArray.symbolJavaStrings[N] + ", " + i + ")");
  ...
  protected void callTemplate(int L, int i, int j, int X /* call with artSlotArray.slotRightSymbols[L - 1] */ ) throws ARTException {
    if (ARTTRACE) artTraceText.println("call(" + artSlotArray.symbolJavaStrings[L] + ", " + i + ", " + j + ")");
  ...
  protected void bsrAddTemplateisEpsilonSlotOrZeroSlotTrue(int slot, int i, int k, int j) throws ARTException {
    if (ARTTRACE)
  ...
  protected void bsrAddTemplateisEpsilonSlotOrZeroSlotFalse(int slot, int i, int k, int j) throws ARTException {
  ...
  protected void processEoC(int slot) throws ARTException {
  ...
  protected void processCat(int slot) throws ARTException {
  ...
  public void artParse(String stringInput) throws ARTException {
    ...
    input = ARTLexerBase.lexicaliseToArrayOfint(stringInput, 0, artSlotArray.symbolJavaStrings, epsilonSlot);
  ...
  protected void artCNPParseBody() throws ARTException {
    // Epsilon
