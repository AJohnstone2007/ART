package uk.ac.rhul.cs.csle.art.alg.earley.indexedapi;
...
public class ARTEarleyIndexedAPI extends ARTParserBase {
  ...
  public ARTEarleyIndexedAPI(ARTGrammar grammar) throws ARTException {
    super(grammar);
  ...
  private boolean inSigmaN(int p) throws ARTException {
  ...
  public void artParse(String stringInput, String inputFilename) throws ARTException {
    if (ARTTRACE) artTraceText = new ARTText(new ARTTextHandlerFile("EarleyIndexedAPITrace.txt"));
