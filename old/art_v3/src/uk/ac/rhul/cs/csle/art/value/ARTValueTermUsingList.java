...
public class ARTValueTermUsingList extends ARTValue {
  ...
  public boolean closedMatchPatternSingletonBindings(ARTValueTermUsingList pattern, Map<ARTValueTermVariable, ARTValueTermUsingList> bindings) throws ARTException {
  ...
  public boolean closedMatchPatternRepeatBindings(ARTValueTermUsingList pattern, Map<ARTValueTermVariable, ARTValueTermUsingList> bindings) throws ARTException {
    if (payload instanceof ARTValueTermVariable)
      throw new ARTException("Attempt to execute closedMatch() on term " + this + " but root is labelled with a variable");
    if (pattern.getPayload() instanceof ARTValueTermVariable) {
      ARTValueTermVariable key = (ARTValueTermVariable) pattern.getPayload();
  ...
  public boolean closedMatchClosed(ARTValueTermUsingList closedTerm) throws ARTException {
    if (payload instanceof ARTValueTermVariable)
  ...
  public ARTValueTermUsingList substitute(Map<ARTValueTermVariable, ARTValueTermUsingList> bindings) throws ARTException {
    if (payload instanceof ARTValueTermVariable) {
