package uk.ac.rhul.cs.csle.art.alg;
...
import uk.ac.rhul.cs.csle.art.alg.gll.support.ARTGLLRDTHandle;
...
import uk.ac.rhul.cs.csle.art.util.ARTHistogram;
...
public abstract class ARTParserBase {
   ...
   */
  public boolean ARTSTATISTICS = false;
  public boolean ARTTRACE = false;
  ...
  public static final int ARTK_CASE_SENSITIVE_TERMINAL = 5;
  public static final int ARTK_CASE_INSENSITIVE_TERMINAL = 6;
  public static final int ARTK_NONTERMINAL = 7;
  public static final int ARTK_INTERMEDIATE = 8;
  public static final int ARTK_END_OF_RULE = 9;
  public static final int ARTK_DO_FIRST = 10;
  public static final int ARTK_OPTIONAL = 11;
  public static final int ARTK_POSITIVE_CLOSURE = 12;
  public static final int ARTK_KLEENE_CLOSURE = 13;
  ...
  protected boolean[] artTerminalsFromNonterminals;
  ...
  public ARTParserBase(ARTGrammar artGrammar, ARTLexerBase artLexer, ARTModeGrammarKind artGrammarKind) {
  ...
  public ARTParserBase(ARTGrammar artGrammar, ARTLexerBase artLexer) {
  ...
  public void artSetLexer(ARTLexerBase artGLLLexer) {
  ...
  public void artRestartClock() {
    artStartTime = System.nanoTime();
  }

  public long artReadClock() {
    return System.nanoTime() - artStartTime;
  }

  public double artTimeAsSeconds(long time) {
    double ret = time / 1.0E9;
    if (ret < 1.0E-9) ret = 0.0;
    return ret;
  }

  public String artGetTimes() {
    return String.format("Setup, %.3f, Lex, %.3f, Parse, %.3f, Derivation select, %.3f, Attribute evaluate, %.3f, eSOS interpret, %.3f",
   ...
   */
  public void artcomputeStatistics() {
  }
  ...
  protected void artEvaluate(ARTGLLRDTHandle element, Object attributes) throws ARTException {
    artEvaluate(element, attributes, new ARTGLLRDTVertex(null, null), false);
  }

  protected void artEvaluate(ARTGLLRDTHandle element, Object attributes, ARTGLLRDTVertex parent, Boolean writeable) throws ARTException {
  };

  protected void artRenderSPPF(ARTText text, int renderKind, ARTLexerBase tweSet) {
  }

  public void artRenderSPPF(String filename, int artRenderKind) throws ARTException {
    artRenderSPPF(filename, artRenderKind, null);
  }

  public void artRenderSPPF(String filename, int artRenderKind, ARTLexerBase tweSet) throws ARTException {
    ...
    artRenderSPPF(text, artRenderKind, tweSet);
    text.println("}");
    text.close();
  }
  ...
  public abstract void artParse(String inputString) throws ARTException;

  public abstract void artParse(String inputString, String nonterminalName) throws ARTException;

  // This is a quick and dirty lexicaliser which does not support ART's special
  // lexical features - first token at element [1]
