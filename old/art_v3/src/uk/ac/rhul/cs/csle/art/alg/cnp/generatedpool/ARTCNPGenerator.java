package uk.ac.rhul.cs.csle.art.alg.cnp.generatedpool;
...
public class ARTCNPGenerator {
  ...
  public ARTCNPGenerator(ARTGrammar artGrammar, ARTOptionBlock optionBlock) throws ARTException {
  ...
  public void generateParser(ARTText artStringText) throws ARTException {
    // System.out.println("- generating parser");
    t = artStringText;

    if (artGrammar.isEBNF()) {
      t.println("import uk.ac.rhul.cs.csle.artcnpgeneratedpool.ARTCNPGeneratedPool;\n" + "import uk.ac.rhul.cs.csle.art.ARTModeGrammarKind;\n"
    ...
    // t.println("package uk.ac.rhul.cs.csle.artgeneratedparser;\n");
    t.println("import uk.ac.rhul.cs.csle.artcnpgeneratedpool.ARTCNPGeneratedPool;\n" + "import uk.ac.rhul.cs.csle.art.ARTModeGrammarKind;\n"
        + "import uk.ac.rhul.cs.csle.art.ARTException;\n\n" + "public class ARTGeneratedParser extends ARTCNPGeneratedPool {");
