...
*/
// For Java...
package uk.ac.rhul.cs.csle.art.alg.earley.indexedpool;
...
public class ARTEarleyIndexedPool extends ARTParserBase {
  ...
  public void artParse(String stringInput, String inputFilename) throws ARTException {
    ...
    // ARTTRACE = true;
    if (ARTTRACE) artTraceText = new ARTText(new ARTTextHandlerFile("EarleySlotArrayPoolTrace.txt"));
  ...
  public void artParse(String inputString) throws ARTException {
    throw new ARTException("No input supplied to " + this.getClass());
  }
}
// End of language customisation
