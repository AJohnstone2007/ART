package uk.ac.rhul.cs.csle.art.alg.earleytable.support;
...
public class ARTChiSet {
  ...
  static boolean isPrefixString(ARTGrammarInstance instance) throws ARTException {
    if (instance instanceof ARTGrammarInstanceSlot) return true;
    if (instance instanceof ARTGrammarInstanceCat) return false;
    throw new ARTException("attempt to classify Chi set element which is neith a prefix nor a production");
  }
