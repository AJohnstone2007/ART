/*******************************************************************************
*
* Parser generated by RDP on Nov 10 2010 08:09:27 from mvmasm.bnf
*
*******************************************************************************/
#include <time.h>
#include "mvm_aux.h"
...
"'INCLUDE'\0" "'LE'\0" "'LT'\0" "'MUL'\0" "'NE'\0" "'PRTI'\0" "'PRTS'\0" "'STRING'\0" 
"'SUB'\0" "'TRUE'\0" "'WORD'\0" "'^'\0" "'|'\0" "'||'\0" "'~'\0" ;
...
/* Set declarations */
  ...
  set_ rdp_diadic_55_first = SET_NULL;
  set_ rdp_diadic_56_first = SET_NULL;
...
RDP_T_MUL, RDP_T_NE, RDP_T_PRTI, RDP_T_PRTS, RDP_T_STRING, RDP_T_SUB, RDP_T_WORD, SET_END);
...
RDP_T_LT, RDP_T_MUL, RDP_T_NE, RDP_T_PRTI, RDP_T_PRTS, RDP_T_STRING, RDP_T_SUB, 
RDP_T_WORD,SET_END);
...
RDP_T_MUL, RDP_T_NE, RDP_T_SUB, SET_END);
...
RDP_T_PRTS, RDP_T_STRING, RDP_T_SUB, RDP_T_WORD, SET_END);
...
RDP_T_EXP, RDP_T_GE, RDP_T_GT, RDP_T_HALT, RDP_T_INCLUDE, RDP_T_LE, RDP_T_LT, 
RDP_T_MUL, RDP_T_NE, RDP_T_PRTI, RDP_T_PRTS, RDP_T_STRING, RDP_T_SUB, RDP_T_WORD, SET_END);
  set_assign_list(&rdp_diadic_55_first, RDP_T_ADD, RDP_T_DIV, RDP_T_EQ, RDP_T_EXP, RDP_T_GE, RDP_T_GT, RDP_T_LE, RDP_T_LT, 
RDP_T_MUL, RDP_T_NE, RDP_T_SUB, SET_END);
  set_assign_list(&rdp_diadic_56_first, RDP_T_ADD, RDP_T_DIV, RDP_T_EQ, RDP_T_EXP, RDP_T_GE, RDP_T_GT, RDP_T_LE, RDP_T_LT, 
RDP_T_MUL, RDP_T_NE, RDP_T_SUB, SET_END);
...
static void diadic(void)
{
  ...
  {
     int op, m1 = 1, m2 = 1; 
    { /* Start of rdp_diadic_55 */
      while (1)
      {
        scan_test_set(NULL, &rdp_diadic_55_first, &diadic_stop);
        {
