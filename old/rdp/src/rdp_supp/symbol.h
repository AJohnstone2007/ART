...
unsigned symbol_hash_string4(unsigned hash_prime, void * data);  /* hash a quartet of null terminated strings */
...
void symbol_print_string4(const void * symbol);  /* print a pointer to four strings */
