...
{
  struct compare_integer_string_struct {int i; char *s1; char *s2;};

  int left_int = ((struct compare_integer_string_struct *) left)->i;
  int right_int = ((struct compare_integer_string_struct *) right)->i;
  char* left_str1 = ((struct compare_integer_string_struct *) left)->s1;
  char* right_str1 = ((struct compare_integer_string_struct *) right)->s1;
  char* left_str2 = ((struct compare_integer_string_struct *) left)->s2;
  char* right_str2 = ((struct compare_integer_string_struct *) right)->s2;
  int ret_value;
  ...
  if (left_int > right_int)
    ...
    ret_value = strcmp(left_str1, right_str1);
    if (ret_value == 0)
...
{                             /* hash a string */
  ...
  unsigned hashnumber = ((struct compare_integer_string_struct *) data)->i;
  char * str1 = ((struct compare_integer_string_struct *) data)->s1;
  char * str2 = ((struct compare_integer_string_struct *) data)->s2;

  if (str1 != NULL)            /* Don't try and scan a vacuous string */
    while (* str1 != 0)        /* run up string */
    hashnumber = * str1++ + hash_prime * hashnumber;

  if (str2 != NULL)            /* Don't try and scan a vacuous string */
    while (* str2 != 0)        /* run up string */
    hashnumber = * str2++ + hash_prime * hashnumber;
...
void symbol_print_integer_string_string(const void * symbol)
{
  ...
  int symbol_i = ((struct compare_integer_string_struct *) symbol)->i;
  char* symbol_s1 = ((struct compare_integer_string_struct *) symbol)->s1;
  char* symbol_s2 = ((struct compare_integer_string_struct *) symbol)->s2;

  if (symbol == NULL)
    text_printf("Null symbol");
  else
    text_printf("%i, %s, %s", symbol_i, symbol_s1, symbol_s2);
}
