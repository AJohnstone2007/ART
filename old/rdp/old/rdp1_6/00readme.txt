The sixth maintenance release of RDP (version 1.6) is now available via ftp 
from ftp.cs.rhbnc.ac.uk in directory /pub/rdp. Get rdp1_6zip if you are an
MS-DOS user or rdp1_6.tar if you are a Unix user. You can also access the
ftp server via the rdp web site at      

      http:\\www.cs.rhul.ac.uk\research\languages\rdp.shmtl


Version 1.6 mostly fixes bugs in version 1.5.
...
ftp server via the rdp web site at      
      ...
      http:\\www.ds.rhul.ac.uk\research\languages\rdp.shmtl
...
- Warranties. This code has only just escaped from my personal toolkit.
  ...
  bug reports.

** RDP release version 1.50 flyer. Adrian Johnstone 16 August 1997 **
...
36. The <body> 'token' construct is now represented by (body)@'token'.
