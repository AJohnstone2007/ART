...
static void rdp__load_keywords(void)   /* install keywords in symbol table */
{
  ...
  scan__load_extended_keyword("[*", T_DQUOTE, E_COMMENT_VISIBLE, "*]");
  scan__load_extended_keyword("\"", T_OSTRING, E_STRING_ESC, "\\");
  scan__load_extended_keyword("(*", T_OCOMMENT, E_COMMENT_NEST, "*)");
}

static void rdp__load_sets(void)       /* initisliase first and stop sets for each production */
{
...
/************** EBNF parser ***************************************/
static rdp__list *alt(void);           /* forward definition */

static symbol__ *item_ret(void)        /* parse a returnable item and return a symbol */
{
  symbol__ *ret = NULL;
...
static symbol__ *item_inl(void)        /* parse an inline item and return a symbol */
{
  symbol__ *ret = NULL;
  rdp__list *body;
...
static rdp__list *seq(void)            /* parse a sequence and return a list */
{
  rdp__list *base = (rdp__list *) crash__calloc(sizeof(rdp__list), "sequence list node"), /* allocate dummy first element */
  *end = base;
...
static rdp__list *alt(void)            /* parse and return a list of alternates */
{
  rdp__list *base,
  *end;

  /* make a dummy list node as a sentinel */
  base = (rdp__list*) crash__calloc(sizeof(rdp__list), "alt list node");
  end = base;
...
static void prod(void)                 /* parse a production */
{
...
static void dir(void)
{
  ...
  case T_OPTION:
    ...
    scan__();
    scan__test(T_OSTRING, prod_stop, "Expecting string");
    temp = (rdp__string_list*) crash__malloc(sizeof(rdp__string_list), "OPTION node allocation");
  ...
  case T_SET_SIZE:
    ...
    scan__test(T_LPAR, dir_stop, "Expecting " "(");
    scan__();
    scan__test(P_INTEGER, dir_stop, "Expecting " "INTEGER");
    rdp__dir_set_size = (unsigned) scan__sym->data.i;
    scan__();
    scan__test(T_RPAR, dir_stop, "Expecting " ")");
    scan__();
    break;
  ...
  case T_HASH_SIZE:
    ...
    scan__();
    scan__test(P_INTEGER, dir_stop, "Expecting " "INTEGER");
    rdp__dir_hash_size = (unsigned) scan__sym->data.i;
    scan__();
    scan__test(T_RPAR, dir_stop, "Expecting " ")");
    scan__();
    break;
  ...
  case T_PASSES:
    ...
    scan__();
    scan__test(P_INTEGER, dir_stop, "Expecting " "INTEGER");
    rdp__dir_passes = (unsigned) scan__sym->data.i;
    scan__();
    scan__test(T_RPAR, dir_stop, "Expecting " ")");
    scan__();
    break;
  ...
  case T_HASH_PRIME:
    ...
    scan__();
    scan__test(P_INTEGER, dir_stop, "Expecting " "INTEGER");
    rdp__dir_hash_prime = (unsigned) scan__sym->data.i;
    scan__();
    scan__test(T_RPAR, dir_stop, "Expecting " ")");
    scan__();
    break;
  ...
  case T_TEXT_SIZE:
    ...
    scan__();
    scan__test(P_INTEGER, dir_stop, "Expecting " "INTEGER");
    rdp__dir_text_size = (unsigned) scan__sym->data.i;
    scan__();
    scan__test(T_RPAR, dir_stop, "Expecting " ")");
    scan__();
    break;
  ...
  case T_TAB_WIDTH:
    ...
    scan__();
    scan__test(P_INTEGER, dir_stop, "Expecting " "INTEGER");
    rdp__dir_tab_width = (unsigned) scan__sym->data.i;
    scan__();
    scan__test(T_RPAR, dir_stop, "Expecting " ")");
    scan__();
    break;
  ...
  case T_MAX_ERRORS:
    ...
    scan__();
    scan__test(P_INTEGER, dir_stop, "Expecting " "INTEGER");
    rdp__dir_max_errors = (unsigned) scan__sym->data.i;
    scan__();
    scan__test(T_RPAR, dir_stop, "Expecting " ")");
    scan__();
    break;
  ...
  case T_MAX_WARNINGS:
    ...
    scan__();
    scan__test(P_INTEGER, dir_stop, "Expecting " "INTEGER");
    rdp__dir_max_warnings = (unsigned) scan__sym->data.i;
    scan__();
    scan__test(T_RPAR, dir_stop, "Expecting " ")");
    scan__();
    break;
...
{
  unsigned tabwidth = 8,        /* tab expansion width */
...
#define FILE_MODE
  ...
  if (scan__open_text("Text mode",
                      scan__load_file(scan__default_filetype(rdp__sourcefilename, "bnf"))) == NULL)
    rdp__help("Can't open source file");
#endif
