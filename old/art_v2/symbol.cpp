...
{
  const char * name;                /* an identifying string */
...
int symbol_compare_integer_string_string(void * left, void * right)
{
  struct compare_integer_string_struct {int i; const char *s; const char *t;};

  int left_int = ((struct compare_integer_string_struct *) left)->i;
  int right_int = ((struct compare_integer_string_struct *) right)->i;
  const char* left_str1 = ((struct compare_integer_string_struct *) left)->s;
  const char* right_str1 = ((struct compare_integer_string_struct *) right)->s;
  const char* left_str2 = ((struct compare_integer_string_struct *) left)->t;
  const char* right_str2 = ((struct compare_integer_string_struct *) right)->t;
  int ret_value;
  ...
  if (left_int > right_int)
    ...
    if ((ret_value = strcmp(left_str1, right_str1)) == 0)
      ret_value = strcmp(left_str2, right_str2);

  return ret_value;
}

int symbol_compare_integer_string_string_string(void * left, void * right)
{
  struct compare_integer_string_struct {int i; const char *s; const char *t; const char* u;};
  ...
  const char* left_str2 = ((struct compare_integer_string_struct *) left)->t;
  const char* right_str2 = ((struct compare_integer_string_struct *) right)->t;
  const char* left_str3 = ((struct compare_integer_string_struct *) left)->u;
  const char* right_str3 = ((struct compare_integer_string_struct *) right)->u;

  if (left_str3 == NULL) left_str3 = "";
  if (right_str3 == NULL) right_str3 = "";
  ...
  if ((ret_value = strcmp(left_str1, right_str1)) != 0) return ret_value;
  if ((ret_value = strcmp(left_str2, right_str2)) != 0) return ret_value;
  if ((ret_value = strcmp(left_str3, right_str3)) != 0) return ret_value;
...
{
  struct compare_integer_string_struct {int i; const char *s; };

  int left_int = ((struct compare_integer_string_struct *) left)->i;
  int right_int = ((struct compare_integer_string_struct *) right)->i;
  const char* left_str = ((struct compare_integer_string_struct *) left)->s;
  const char* right_str = ((struct compare_integer_string_struct *) right)->s;
  int ret_value;
...
{                             /* hash a string */
  ...
  const char * string = *(const char * *)((unsigned *) data + 1);
...
{                             /* hash a string */
  ...
  unsigned const char *string = data_struct->set.elements;
...
{                             /* hash a string */
  ...
  unsigned const char *string = data_set->elements;
...
{                             /* hash a string */
  ...
  const char * str = ((struct compare_integer_string_struct *) data)->s;
...
unsigned symbol_hash_integer_string_string(unsigned hash_prime, void * data)
{                             /* hash a string */
  struct compare_integer_string_struct {int i; const char *s; const char *t;};
  ...
  str = ((struct compare_integer_string_struct *) data)->t;
...
unsigned symbol_hash_integer_string_string_string(unsigned hash_prime, void * data)
{                             /* hash a string */
  struct compare_integer_string_struct {int i; const char *s; const char *t; const char*u;};
  ...
  str = ((struct compare_integer_string_struct *) data)->u;
...
void * symbol_new_scope(void * table, const char * id)
{
...
void * symbol_new_table(const char * name,
...
{
  text_printf("%s", symbol == NULL ? "Null symbol": *((const char * *) symbol));
}
...
void symbol_print_integer_string(const void * symbol)
{
  ...
  const char* symbol_s = ((struct compare_integer_string_struct *) symbol)->s;
...
void symbol_print_integer_string_string(const void * symbol)
{
  struct compare_integer_string_struct {int i; const char *s; const char *t;};

  int symbol_i = ((struct compare_integer_string_struct *) symbol)->i;
  const char* symbol_s = ((struct compare_integer_string_struct *) symbol)->s;
  const char* symbol_t = ((struct compare_integer_string_struct *) symbol)->t;

  if (symbol == NULL)
    text_printf("Null symbol");
  else
    text_printf("%i, %s, %s", symbol_i, symbol_s, symbol_t);
}

void symbol_print_integer_string_string_string(const void * symbol)
{
  struct compare_integer_string_struct {int i; const char *s; const char *t; const char* u;};
  ...
  const char* symbol_s = ((struct compare_integer_string_struct *) symbol)->s;
  const char* symbol_t = ((struct compare_integer_string_struct *) symbol)->t;
  const char* symbol_u = ((struct compare_integer_string_struct *) symbol)->u;

  if (symbol == NULL)
    text_printf("Null symbol");
  else
    text_printf("%i, %s, %s, %s", symbol_i, symbol_s, symbol_t, symbol_u);
}
...
void symbol_set_scope_name(void * table, const char* name)
{
