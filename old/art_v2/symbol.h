...
enum SYMBOL_FIND_OP{SYMBOL_ILLEGAL_OP, SYMBOL_NEW, SYMBOL_OLD, SYMBOL_ANY, SYMBOL_MULTIPLE};
...
void * symbol_new_scope(void * table, const char * str);  /* make a new scope symbol */
...
void symbol_print_integer_string_string(const void * symbol);  /* print a pointer to a long */
void symbol_print_integer_string_string_string(const void * symbol);  /* print a pointer to a long */
...
void symbol_set_scope_name(void * table, const char* name);  /* set current scope name */
