...
g++ -fsanitize=address               -fpermissive -O3 -ogtb_mgw32_gcc_O3_sanitize      -Wno-write-strings -I../src/gtb -I../src/gtb_lib ../src/gtb/*.cpp ../src/gtb_lib/*.cpp
g++ -fsanitize=address -DBRNGLR_POOL -fpermissive -O3 -ogtb_mgw32_gcc_O3_pool_sanitize -Wno-write-strings -I../src/gtb -I../src/gtb_lib ../src/gtb/*.cpp ../src/gtb_lib/*.cpp
