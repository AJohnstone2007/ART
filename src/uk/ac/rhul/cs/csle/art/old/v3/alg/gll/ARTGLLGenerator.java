...
import uk.ac.rhul.cs.csle.art.old.v4.util.text.ARTTextHandlerSink;
      ...
      for (ARTGrammarElement e : set) {
        if (e instanceof ARTGrammarElementTerminal) {
          ...
          if (e.equals(grammar.getEoS()))
            gt.assignBooleanArrayElement("ARTSet" + mergedSets.get(set), e.toEnumerationString("X"), "true");
          else
            gt.assignBooleanArrayElement("ARTSet" + mergedSets.get(set), e.toEnumerationString(null), "true");
