...
public class ARTTGParser extends ARTGLLParserHashPool {
  ...
  public void ARTPF_ART_acceptOpt() {
    ...
    case ARTL_ART_acceptOpt_56:
      ...
      artCurrentRestartLabel = ARTL_ART_strings;
      return;
    }
  ...
  public void ARTPF_ART_optionOpt() {
    ...
    case ARTL_ART_optionOpt_40:
      ...
      artCurrentRestartLabel = ARTL_ART_stringBrace;
      return;
    }
  ...
  public void ARTPF_ART_strings() {
    ...
    case ARTL_ART_strings_90:
      ...
      artCurrentRestartLabel = ARTL_ART_stringDollar;
      return;
    }
  ...
  public void ARTPF_ART_test() {
    ...
    case ARTL_ART_test_18:
      ...
      artCurrentRestartLabel = ARTL_ART_ID;
      return;
    }
    case ARTL_ART_test_20:
      ...
      artCurrentRestartLabel = ARTL_ART_optionOpt;
      return;
    }
    ...
    case ARTL_ART_test_24:
      ...
      artCurrentRestartLabel = ARTL_ART_acceptOpt;
      return;
    }
    case ARTL_ART_test_28:
      ...
      artCurrentRestartLabel = ARTL_ART_rejectOpt;
      return;
    }
  ...
  public void ARTPF_ART_tests() {
    ...
    case ARTL_ART_tests_8:
      ...
      artCurrentRestartLabel = ARTL_ART_test;
      return;
    }
    case ARTL_ART_tests_10:
      ...
      artCurrentRestartLabel = ARTL_ART_tests;
      return;
    }
        ...
        case ARTL_ART_acceptOpt_62:
          ...
          artNewParent = artParent.addChild(artNextFreeNodeNumber++,
              new ARTGLLRDTPayload(artRDT, artSPPFNodeLeftExtent(artSPPFPackedNodeRightChild(artPackedNode)),
                  artSPPFNodeRightExtent(artSPPFPackedNodeRightChild(artPackedNode)), artSPPFNodeLabel(artSPPFPackedNodeRightChild(artPackedNode)), strings1));
  ...
  public void ARTRD_optionOpt(int artElement, ARTGLLRDTVertex artParent, boolean artWriteable, ARTAT_ART_optionOpt optionOpt,
      ARTAT_ART_stringBrace stringBrace1) {
    ARTGLLRDTVertex artNewParent;
    boolean artNewWriteable = true;
    for (int artPackedNode = artSPPFNodePackedNodeList(artElement); artPackedNode != 0; artPackedNode = artSPPFPackedNodePackedNodeList(artPackedNode)) {
      if (artSPPFPackedNodeSelected(artPackedNode)) {
        ...
        case ARTL_ART_optionOpt_42:
          ...
          artNewParent = artParent.addChild(artNextFreeNodeNumber++,
              new ARTGLLRDTPayload(artRDT, artSPPFNodeLeftExtent(artSPPFPackedNodeRightChild(artPackedNode)),
                  artSPPFNodeRightExtent(artSPPFPackedNodeRightChild(artPackedNode)), artSPPFNodeLabel(artSPPFPackedNodeRightChild(artPackedNode)),
                  stringBrace1));
    ...
    for (int artPackedNode = artSPPFNodePackedNodeList(artElement); artPackedNode != 0; artPackedNode = artSPPFPackedNodePackedNodeList(artPackedNode)) {
      if (artSPPFPackedNodeSelected(artPackedNode)) {
        ...
        case ARTL_ART_stringBrace_82:
          ...
          artParent.addChild(artNextFreeNodeNumber++, new ARTGLLRDTPayload(artRDT, artSPPFNodeLeftExtent(artSPPFPackedNodeRightChild(artPackedNode)),
              artSPPFNodeRightExtent(artSPPFPackedNodeRightChild(artPackedNode)), artSPPFNodeLabel(artSPPFPackedNodeRightChild(artPackedNode)), null));
          stringBrace.lexeme = artLexeme(stringBrace.leftExtent, stringBrace.rightExtent);
          stringBrace.v = artLexemeAsString(stringBrace.leftExtent, stringBrace.rightExtent);
          break;
        default:
          ;
        }
    ...
    for (int artPackedNode = artSPPFNodePackedNodeList(artElement); artPackedNode != 0; artPackedNode = artSPPFPackedNodePackedNodeList(artPackedNode)) {
      if (artSPPFPackedNodeSelected(artPackedNode)) {
        ...
        case ARTL_ART_stringDollar_52:
          ...
          artParent.addChild(artNextFreeNodeNumber++, new ARTGLLRDTPayload(artRDT, artSPPFNodeLeftExtent(artSPPFPackedNodeRightChild(artPackedNode)),
              artSPPFNodeRightExtent(artSPPFPackedNodeRightChild(artPackedNode)), artSPPFNodeLabel(artSPPFPackedNodeRightChild(artPackedNode)), null));
          stringDollar.lexeme = artLexeme(stringDollar.leftExtent, stringDollar.rightExtent);
          stringDollar.v = artLexemeAsRawString(stringDollar.leftExtent, stringDollar.rightExtent);
          break;
        default:
          ;
        }
  ...
  public void ARTRD_strings(int artElement, ARTGLLRDTVertex artParent, boolean artWriteable, ARTAT_ART_strings strings, ARTAT_ART_stringDollar stringDollar1,
      ARTAT_ART_strings strings1) {
    ARTGLLRDTVertex artNewParent;
    boolean artNewWriteable = true;
    for (int artPackedNode = artSPPFNodePackedNodeList(artElement); artPackedNode != 0; artPackedNode = artSPPFPackedNodePackedNodeList(artPackedNode)) {
      if (artSPPFPackedNodeSelected(artPackedNode)) {
        ...
        case ARTL_ART_strings_96:
          ...
          artNewParent = artParent.addChild(artNextFreeNodeNumber++,
              new ARTGLLRDTPayload(artRDT, artSPPFNodeLeftExtent(artSPPFPackedNodeLeftChild(artPackedNode)),
                  artSPPFNodeRightExtent(artSPPFPackedNodeLeftChild(artPackedNode)), artSPPFNodeLabel(artSPPFPackedNodeLeftChild(artPackedNode)),
                  stringDollar1));
          ...
          try {
            PrintWriter out = new PrintWriter(new File(strings.fileName + "_" + stringCount++));
  ...
  public void ARTRD_test(int artElement, ARTGLLRDTVertex artParent, boolean artWriteable, ARTAT_ART_ID ID1, ARTAT_ART_acceptOpt acceptOpt1,
      ARTAT_ART_optionOpt optionOpt1, ARTAT_ART_rejectOpt rejectOpt1, ARTAT_ART_stringDollar stringDollar1) {
    ARTGLLRDTVertex artNewParent;
    boolean artNewWriteable = true;
    for (int artPackedNode = artSPPFNodePackedNodeList(artElement); artPackedNode != 0; artPackedNode = artSPPFPackedNodePackedNodeList(artPackedNode)) {
      if (artSPPFPackedNodeSelected(artPackedNode)) {
        ...
        case ARTL_ART_test_22:
          ...
          artNewParent = artParent.addChild(artNextFreeNodeNumber++,
              new ARTGLLRDTPayload(artRDT, artSPPFNodeLeftExtent(artSPPFPackedNodeLeftChild(artPackedNode)),
                  artSPPFNodeRightExtent(artSPPFPackedNodeLeftChild(artPackedNode)), artSPPFNodeLabel(artSPPFPackedNodeLeftChild(artPackedNode)), ID1));
        ...
        case ARTL_ART_test_24:
          ...
          for (cc = 0; cc < stringDollar1.v.length(); cc++) {
            if (stringDollar1.v.charAt(cc) == '_' || Character.isLetter(stringDollar1.v.charAt(cc))) break;
            if (stringDollar1.v.charAt(cc) == '(' && stringDollar1.v.charAt(cc + 1) == '*') do
              cc++;
          ...
          try {
            PrintWriter out = new PrintWriter(new File(ID1.v + ".art"));
            if (vv3) {
          ...
          System.err.println("New" + (vv3 ? " vv3" : " v2") + " test file '" + ID1.v + "' with options '"
              + optionOpt1.v /* + "': grammar '" + stringDollar1.v + "' mapped to '" + stringBuilder.toString() + "'" */);
          stringCount = 1;
  ...
  public void artEvaluate(ARTGLLRDTHandle artElement, ARTGLLAttributeBlock artAttributes, ARTGLLRDTVertex artParent, Boolean artWriteable) {
    ...
    case ARTL_ART_ID:
      ARTRD_ID(artElement.element, artParent, artWriteable, (ARTAT_ART_ID) artAttributes);
      break;
    case ARTL_ART_acceptOpt:
      ARTRD_acceptOpt(artElement.element, artParent, artWriteable, (ARTAT_ART_acceptOpt) artAttributes, null);
      break;
    case ARTL_ART_optionOpt:
      ARTRD_optionOpt(artElement.element, artParent, artWriteable, (ARTAT_ART_optionOpt) artAttributes, null);
      break;
    case ARTL_ART_rejectOpt:
      ARTRD_rejectOpt(artElement.element, artParent, artWriteable, (ARTAT_ART_rejectOpt) artAttributes, null);
      break;
    case ARTL_ART_stringBrace:
      ARTRD_stringBrace(artElement.element, artParent, artWriteable, (ARTAT_ART_stringBrace) artAttributes);
      break;
    case ARTL_ART_stringDollar:
      ARTRD_stringDollar(artElement.element, artParent, artWriteable, (ARTAT_ART_stringDollar) artAttributes);
      break;
    case ARTL_ART_strings:
      ARTRD_strings(artElement.element, artParent, artWriteable, (ARTAT_ART_strings) artAttributes, null, null);
      break;
    case ARTL_ART_test:
      ARTRD_test(artElement.element, artParent, artWriteable, null, null, null, null, null);
      break;
    case ARTL_ART_tests:
      ARTRD_tests(artElement.element, artParent, artWriteable);
      break;
    case ARTL_ART_text:
      ARTRD_text(artElement.element, artParent, artWriteable, (ARTAT_ART_text) artAttributes);
      break;
    }
  }
