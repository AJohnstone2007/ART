...
//  private final String scriptParserTermString = "rules(directive(whitespace(cfgBuiltinTerminal(SIMPLE_WHITESPACE), cfgBuiltinTerminal(COMMENT_NEST_ART), cfgBuiltinTerminal(COMMENT_LINE_C))), cfgRule(cfgLHS(rules), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgNonterminal(rule), cfgSlot, cfgFoldUnder(cfgNonterminal(rules)), cfgSlot), cfgSeq(cfgSlot, cfgNonterminal(rule), cfgSlot))), cfgRule(cfgLHS(rule), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgFoldOver(cfgNonterminal(cfgRule)), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgNonterminal(trRule)), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgNonterminal(chooseRule)), cfgSlot), cfgSeq(cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(!)), cfgSlot, cfgFoldOver(cfgNonterminal(directive)), cfgSlot))), cfgRule(cfgLHS(cfgRule), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgNonterminal(cfgLHS), cfgSlot, cfgNonterminal(cfgAttributeDeclarations), cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(\\:\\:=)), cfgSlot, cfgNonterminal(cfgAlts), cfgSlot))), cfgRule(cfgLHS(cfgLHS), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgNonterminal(ID), cfgSlot))), cfgRule(cfgLHS(cfgAttributeDeclarations), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgFoldUnder(cfgEpsilon)), cfgSeq(cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(<)), cfgSlot, cfgFoldOver(cfgNonterminal(cfgAttributeDeclaration)), cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(>)), cfgSlot))), cfgRule(cfgLHS(cfgAttributeDeclaration), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgNonterminal(ID), cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(\\:)), cfgSlot, cfgNonterminal(ID), cfgSlot), cfgSeq(cfgSlot, cfgNonterminal(ID), cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(\\:)), cfgSlot, cfgNonterminal(ID), cfgSlot, cfgNonterminal(cfgAttributeDeclaration), cfgSlot))), cfgRule(cfgLHS(cfgAlts), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgNonterminal(cfgAlt), cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(|)), cfgSlot, cfgFoldUnder(cfgNonterminal(cfgAlts)), cfgSlot), cfgSeq(cfgSlot, cfgNonterminal(cfgAlt), cfgSlot))), cfgRule(cfgLHS(cfgAlt), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgFoldOver(cfgNonterminal(cfgSeq)), cfgSlot, cfgNonterminal(cfgActions), cfgSlot, cfgNonterminal(cfgEpsilonCarrier), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgNonterminal(cfgSeq)), cfgSlot, cfgNonterminal(cfgActions), cfgSlot, cfgNonterminal(cfgEpsilon), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgNonterminal(cfgSeq)), cfgSlot, cfgFoldUnder(cfgNonterminal(cfgElems)), cfgSlot, cfgNonterminal(cfgActions), cfgSlot))), cfgRule(cfgLHS(cfgEpsilonCarrier), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgNonterminal(cfgEpsilon), cfgSlot, cfgFoldOver(cfgNonterminal(cfgAnnotation)), cfgSlot))), cfgRule(cfgLHS(cfgEpsilon), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(#)), cfgSlot))), cfgRule(cfgLHS(cfgAltNoAction), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgFoldOver(cfgNonterminal(cfgSeq)), cfgSlot, cfgNonterminal(cfgSlot), cfgSlot, cfgNonterminal(cfgName), cfgSlot, cfgNonterminal(cfgSlot), cfgSlot))), cfgRule(cfgLHS(cfgElems), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgNonterminal(cfgActions), cfgSlot, cfgNonterminal(cfgExtended), cfgSlot, cfgFoldUnder(cfgNonterminal(cfgElems)), cfgSlot), cfgSeq(cfgSlot, cfgNonterminal(cfgActions), cfgSlot, cfgNonterminal(cfgExtended), cfgSlot))), cfgRule(cfgLHS(cfgExtended), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgNonterminal(cfgName), cfgSlot, cfgFoldOver(cfgNonterminal(cfgAnnotation)), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgNonterminal(cfgName)), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgNonterminal(cfgOptional)), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgNonterminal(cfgKleene)), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgNonterminal(cfgPositive)), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgNonterminal(cfgDoFirst)), cfgSlot))), cfgRule(cfgLHS(cfgAnnotation), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgFoldOver(cfgNonterminal(cfgFoldUnder)), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgNonterminal(cfgFoldOver)), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgNonterminal(cfgFoldTear)), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgNonterminal(cfgFoldTearNamed)), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgNonterminal(cfgDelay)), cfgSlot))), cfgRule(cfgLHS(cfgFoldUnder), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(^)), cfgSlot))), cfgRule(cfgLHS(cfgFoldOver), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(^^)), cfgSlot))), cfgRule(cfgLHS(cfgFoldTear), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(^^^)), cfgSlot))), cfgRule(cfgLHS(cfgFoldTearNamed), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(^^^)), cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(\\:)), cfgSlot, cfgNonterminal(ID), cfgSlot))), cfgRule(cfgLHS(cfgDelay), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgCaseSensitiveTerminal(!<), cfgSlot))), cfgRule(cfgLHS(cfgDoFirst), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(\\()), cfgSlot, cfgNonterminal(cfgAlts), cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(\\))), cfgSlot))), cfgRule(cfgLHS(cfgOptional), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(\\()), cfgSlot, cfgNonterminal(cfgAlts), cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(\\))), cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(?)), cfgSlot), cfgSeq(cfgSlot, cfgNonterminal(cfgAltNoAction), cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(?)), cfgSlot))), cfgRule(cfgLHS(cfgPositive), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(\\()), cfgSlot, cfgNonterminal(cfgAlts), cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(\\))), cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(+)), cfgSlot), cfgSeq(cfgSlot, cfgNonterminal(cfgAltNoAction), cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(+)), cfgSlot))), cfgRule(cfgLHS(cfgKleene), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(\\()), cfgSlot, cfgNonterminal(cfgAlts), cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(\\))), cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(*)), cfgSlot), cfgSeq(cfgSlot, cfgNonterminal(cfgAltNoAction), cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(*)), cfgSlot))), cfgRule(cfgLHS(cfgName), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgFoldOver(cfgNonterminal(cfgPrim)), cfgSlot), cfgSeq(cfgSlot, cfgNonterminal(cfgPrim), cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(\\:)), cfgSlot, cfgNonterminal(ID), cfgSlot))), cfgRule(cfgLHS(cfgPrim), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgFoldOver(cfgNonterminal(cfgNonterminal)), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgNonterminal(cfgCaseSensitiveTerminal)), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgNonterminal(cfgCaseInsensitiveTerminal)), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgNonterminal(cfgBuiltinTerminal)), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgNonterminal(cfgBuiltinNoWSTerminal)), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgNonterminal(cfgCharacterTerminal)), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgNonterminal(cfgCharacterRangeTerminal)), cfgSlot))), cfgRule(cfgLHS(cfgNonterminal), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgNonterminal(ID), cfgSlot), cfgSeq(cfgSlot, cfgNonterminal(STRING_DOLLAR), cfgSlot))), cfgRule(cfgLHS(cfgCaseSensitiveTerminal), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgNonterminal(STRING_PLAIN_SQ), cfgSlot))), cfgRule(cfgLHS(cfgCaseInsensitiveTerminal), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgNonterminal(STRING_DQ), cfgSlot))), cfgRule(cfgLHS(cfgBuiltinTerminal), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(&)), cfgSlot, cfgNonterminal(ID), cfgSlot))), cfgRule(cfgLHS(cfgBuiltinNoWSTerminal), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(&&)), cfgSlot, cfgNonterminal(ID), cfgSlot))), cfgRule(cfgLHS(cfgCharacterTerminal), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgNonterminal(CHAR_BQ), cfgSlot))), cfgRule(cfgLHS(cfgCharacterRangeTerminal), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgNonterminal(cfgRange), cfgSlot))), cfgRule(cfgLHS(cfgRange), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgNonterminal(CHAR_BQ), cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(..)), cfgSlot, cfgNonterminal(CHAR_BQ), cfgSlot))), cfgRule(cfgLHS(cfgActions), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgFoldOver(cfgNonterminal(cfgSlot)), cfgSlot, cfgFoldUnder(cfgNonterminal(cfgActionSeq)), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgNonterminal(cfgSlot)), cfgSlot))), cfgRule(cfgLHS(cfgActionSeq), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgNonterminal(cfgAction), cfgSlot, cfgFoldUnder(cfgNonterminal(cfgActionSeq)), cfgSlot), cfgSeq(cfgSlot, cfgNonterminal(cfgAction), cfgSlot))), cfgRule(cfgLHS(cfgAction), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgFoldOver(cfgNonterminal(cfgEquation)), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgNonterminal(cfgAssignment)), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgNonterminal(cfgNative)), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgNonterminal(cfgInsert)), cfgSlot))), cfgRule(cfgLHS(cfgEquation), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgNonterminal(cfgAttribute), cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(=)), cfgSlot, cfgNonterminal(cfgExpression), cfgSlot))), cfgRule(cfgLHS(cfgAssignment), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgNonterminal(cfgAttribute), cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(\\:=)), cfgSlot, cfgNonterminal(cfgExpression), cfgSlot))), cfgRule(cfgLHS(cfgNative), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgNonterminal(STRING_SHRIEK_SHRIEK), cfgSlot))), cfgRule(cfgLHS(cfgInsert), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(^+\\:)), cfgSlot, cfgNonterminal(ID), cfgSlot))), cfgRule(cfgLHS(cfgAttribute), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgNonterminal(ID), cfgSlot), cfgSeq(cfgSlot, cfgNonterminal(ID), cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(.)), cfgSlot, cfgNonterminal(ID), cfgSlot))), cfgRule(cfgLHS(cfgExpression), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgFoldOver(cfgNonterminal(__bool)), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgNonterminal(__intAP)), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgNonterminal(__int32)), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgNonterminal(__realAP)), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgNonterminal(__real64)), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgNonterminal(__string)), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgNonterminal(__char)), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgNonterminal(cfgAttribute)), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgNonterminal(ID)), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgNonterminal(ID)), cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(\\()), cfgSlot, cfgFoldUnder(cfgNonterminal(cfgExpressionList)), cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(\\))), cfgSlot))), cfgRule(cfgLHS(cfgExpressionList), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgNonterminal(cfgExpression), cfgSlot), cfgSeq(cfgSlot, cfgNonterminal(cfgExpression), cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(\\,)), cfgSlot, cfgFoldUnder(cfgNonterminal(cfgExpressionList)), cfgSlot))), cfgRule(cfgLHS(cfgSeq), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgFoldUnder(cfgEpsilon)))), cfgRule(cfgLHS(cfgSlot), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgFoldUnder(cfgEpsilon)))), cfgRule(cfgLHS(trRule), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgNonterminal(trLabel), cfgSlot, cfgNonterminal(tr), cfgSlot))), cfgRule(cfgLHS(trLabel), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgFoldUnder(cfgEpsilon)), cfgSeq(cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(-)), cfgSlot, cfgNonterminal(ID), cfgSlot))), cfgRule(cfgLHS(tr), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgNonterminal(trPremises), cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(---)), cfgSlot, cfgNonterminal(trTransition), cfgSlot))), cfgRule(cfgLHS(trPremises), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgFoldUnder(cfgEpsilon)), cfgSeq(cfgSlot, cfgNonterminal(trMatch), cfgSlot, cfgFoldUnder(cfgNonterminal(trPremises)), cfgSlot), cfgSeq(cfgSlot, cfgNonterminal(trTransition), cfgSlot, cfgFoldUnder(cfgNonterminal(trPremises)), cfgSlot))), cfgRule(cfgLHS(trMatch), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgNonterminal(trTopTuple), cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(|>)), cfgSlot, cfgNonterminal(trTopTuple), cfgSlot))), cfgRule(cfgLHS(trTransition), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgNonterminal(trTopTuple), cfgSlot, cfgFoldUnder(cfgNonterminal(trRelation)), cfgSlot, cfgNonterminal(trTopTuple), cfgSlot))), cfgRule(cfgLHS(trTopTuple), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgNonterminal(trTerm), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgNonterminal(trTuple)), cfgSlot, cfgFoldUnder(cfgNonterminal(trTerms)), cfgSlot))), cfgRule(cfgLHS(trTuple), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgFoldUnder(cfgEpsilon)))), cfgRule(cfgLHS(trTerms), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgNonterminal(trTerm), cfgSlot, cfgFoldUnder(cfgNonterminal(trTermsTail)), cfgSlot))), cfgRule(cfgLHS(trTermsTail), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(\\,)), cfgSlot, cfgNonterminal(trTerm), cfgSlot), cfgSeq(cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(\\,)), cfgSlot, cfgNonterminal(trTerm), cfgSlot, cfgFoldUnder(cfgNonterminal(trTermsTail)), cfgSlot))), cfgRule(cfgLHS(trTerm), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgFoldOver(cfgNonterminal(__bool)), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgNonterminal(__char)), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgNonterminal(__intAP)), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgNonterminal(__int32)), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgNonterminal(__realAP)), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgNonterminal(__real64)), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgNonterminal(__string)), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgNonterminal(__array)), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgNonterminal(__list)), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgNonterminal(__set)), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgNonterminal(__map)), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgNonterminal(ID)), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgNonterminal(IDSTAR)), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgNonterminal(ID)), cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(\\()), cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(\\))), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgNonterminal(ID)), cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(\\()), cfgSlot, cfgNonterminal(trTerm), cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(\\))), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgNonterminal(ID)), cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(\\()), cfgSlot, cfgFoldUnder(cfgNonterminal(trTerms)), cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(\\))), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgNonterminal(trTuple)), cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(<)), cfgSlot, cfgFoldUnder(cfgNonterminal(trTerms)), cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(>)), cfgSlot))), cfgRule(cfgLHS(__array), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal([)), cfgSlot, cfgNonterminal(__int32), cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(|)), cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(])), cfgSlot), cfgSeq(cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal([)), cfgSlot, cfgNonterminal(__int32), cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(|)), cfgSlot, cfgNonterminal(__a), cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(])), cfgSlot))), cfgRule(cfgLHS(__a), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgNonterminal(trTerm), cfgSlot), cfgSeq(cfgSlot, cfgNonterminal(trTerm), cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(\\,)), cfgSlot, cfgNonterminal(__a), cfgSlot))), cfgRule(cfgLHS(__list), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal([)), cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(])), cfgSlot), cfgSeq(cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal([)), cfgSlot, cfgNonterminal(__l), cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(])), cfgSlot))), cfgRule(cfgLHS(__l), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgNonterminal(trTerm), cfgSlot), cfgSeq(cfgSlot, cfgNonterminal(trTerm), cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(\\,)), cfgSlot, cfgNonterminal(__l), cfgSlot))), cfgRule(cfgLHS(__set), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal({)), cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(})), cfgSlot), cfgSeq(cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal({)), cfgSlot, cfgNonterminal(__s), cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(})), cfgSlot))), cfgRule(cfgLHS(__s), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgNonterminal(trTerm), cfgSlot), cfgSeq(cfgSlot, cfgNonterminal(trTerm), cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(\\,)), cfgSlot, cfgNonterminal(__s), cfgSlot))), cfgRule(cfgLHS(__map), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal({)), cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(=)), cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(})), cfgSlot), cfgSeq(cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal({)), cfgSlot, cfgNonterminal(__m), cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(})), cfgSlot))), cfgRule(cfgLHS(__m), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgNonterminal(trTerm), cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(=)), cfgSlot, cfgNonterminal(trTerm), cfgSlot), cfgSeq(cfgSlot, cfgNonterminal(trTerm), cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(=)), cfgSlot, cfgNonterminal(trTerm), cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(\\,)), cfgSlot, cfgNonterminal(__m), cfgSlot))), cfgRule(cfgLHS(trRelation), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgCaseSensitiveTerminal(->), cfgSlot), cfgSeq(cfgSlot, cfgCaseSensitiveTerminal(=>), cfgSlot), cfgSeq(cfgSlot, cfgCaseSensitiveTerminal(~>), cfgSlot), cfgSeq(cfgSlot, cfgCaseSensitiveTerminal(\\:->), cfgSlot), cfgSeq(cfgSlot, cfgCaseSensitiveTerminal(\\:=>), cfgSlot), cfgSeq(cfgSlot, cfgCaseSensitiveTerminal(\\:~>), cfgSlot))), cfgRule(cfgLHS(chooseRule), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgFoldOver(cfgNonterminal(chooseElementRule)), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgNonterminal(chooseSlotRule)), cfgSlot))), cfgRule(cfgLHS(chooseElementRule), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgNonterminal(chooseElementExpr), cfgSlot, cfgFoldOver(cfgNonterminal(chooserOp)), cfgSlot, cfgNonterminal(chooseElementExpr), cfgSlot))), cfgRule(cfgLHS(chooseSlotRule), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgNonterminal(chooseSlotExpr), cfgSlot, cfgFoldOver(cfgNonterminal(chooserOp)), cfgSlot, cfgNonterminal(chooseSlotExpr), cfgSlot))), cfgRule(cfgLHS(chooseElementExpr), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgFoldOver(cfgNonterminal(chooseElement)), cfgSlot), cfgSeq(cfgSlot, cfgNonterminal(chooseElementExpr), cfgSlot, cfgFoldOver(cfgNonterminal(chooseSetOp)), cfgSlot, cfgNonterminal(chooseElement), cfgSlot))), cfgRule(cfgLHS(chooseSlotExpr), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgFoldOver(cfgNonterminal(chooseSlot)), cfgSlot), cfgSeq(cfgSlot, cfgNonterminal(chooseSlotExpr), cfgSlot, cfgFoldOver(cfgNonterminal(chooseSetOp)), cfgSlot, cfgNonterminal(chooseSlot), cfgSlot))), cfgRule(cfgLHS(chooseElement), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgNonterminal(cfgNonterminal), cfgSlot), cfgSeq(cfgSlot, cfgNonterminal(cfgCharacterTerminal), cfgSlot), cfgSeq(cfgSlot, cfgNonterminal(cfgBuiltinTerminal), cfgSlot), cfgSeq(cfgSlot, cfgNonterminal(cfgCaseInsensitiveTerminal), cfgSlot), cfgSeq(cfgSlot, cfgNonterminal(cfgCaseSensitiveTerminal), cfgSlot), cfgSeq(cfgSlot, cfgFoldUnder(cfgNonterminal(choosePredefinedElementSet)), cfgSlot), cfgSeq(cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(\\()), cfgSlot, cfgNonterminal(chooseElementExpr), cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(\\))), cfgSlot))), cfgRule(cfgLHS(chooseSlot), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgNonterminal(cfgLHS), cfgSlot, cfgCaseSensitiveTerminal(\\:\\:=), cfgSlot, cfgNonterminal(cfgAlt), cfgSlot), cfgSeq(cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(\\()), cfgSlot, cfgNonterminal(chooseSlotExpr), cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(\\))), cfgSlot))), cfgRule(cfgLHS(choosePredefinedElementSet), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgCaseSensitiveTerminal(anyCharacterTerminal), cfgSlot), cfgSeq(cfgSlot, cfgCaseSensitiveTerminal(anyBuiltinTerminal), cfgSlot), cfgSeq(cfgSlot, cfgCaseSensitiveTerminal(anyCaseSensitiveTerminal), cfgSlot), cfgSeq(cfgSlot, cfgCaseSensitiveTerminal(anyCaseInsensitiveTerminal), cfgSlot), cfgSeq(cfgSlot, cfgCaseSensitiveTerminal(anyParaterminal), cfgSlot), cfgSeq(cfgSlot, cfgCaseSensitiveTerminal(anyLiteralTerminal), cfgSlot), cfgSeq(cfgSlot, cfgCaseSensitiveTerminal(anyTerminal), cfgSlot), cfgSeq(cfgSlot, cfgCaseSensitiveTerminal(anyNonterminal), cfgSlot))), cfgRule(cfgLHS(choosePredefinedSlotSet), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgCaseSensitiveTerminal(anySlot), cfgSlot))), cfgRule(cfgLHS(chooserOp), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgFoldOver(cfgNonterminal(chooseHigher)), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgNonterminal(chooseLower)), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgNonterminal(chooseLonger)), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgNonterminal(chooseShorter)), cfgSlot))), cfgRule(cfgLHS(chooseHigher), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(>)), cfgSlot))), cfgRule(cfgLHS(chooseLower), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(<)), cfgSlot))), cfgRule(cfgLHS(chooseLonger), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(>>)), cfgSlot))), cfgRule(cfgLHS(chooseShorter), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(<<)), cfgSlot))), cfgRule(cfgLHS(chooseSetOp), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgNonterminal(chooseUnion), cfgSlot), cfgSeq(cfgSlot, cfgNonterminal(chooseDifference), cfgSlot), cfgSeq(cfgSlot, cfgNonterminal(chooseIntersection), cfgSlot), cfgSeq(cfgSlot, cfgNonterminal(chooseSymmetricDifference), cfgSlot))), cfgRule(cfgLHS(chooseUnion), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(+)), cfgSlot))), cfgRule(cfgLHS(chooseDifference), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(-)), cfgSlot))), cfgRule(cfgLHS(chooseIntersection), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(*)), cfgSlot))), cfgRule(cfgLHS(chooseSymmetricDifference), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(/)), cfgSlot))), cfgRule(cfgLHS(directive), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgNonterminal(directiveElement), cfgSlot))), cfgRule(cfgLHS(directiveElement), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgCaseSensitiveTerminal(include), cfgSlot, cfgNonterminal(file), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgCaseSensitiveTerminal(whitespace)), cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(#)), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgCaseSensitiveTerminal(whitespace)), cfgSlot, cfgFoldUnder(cfgNonterminal(whiteSpaceElements)), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgCaseSensitiveTerminal(whitespace)), cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(\\()), cfgSlot, cfgFoldUnder(cfgNonterminal(whiteSpaceElements)), cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(\\))), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgCaseSensitiveTerminal(deleteTokens)), cfgSlot, cfgNonterminal(__int32), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgCaseSensitiveTerminal(swapTokens)), cfgSlot, cfgNonterminal(__int32), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgCaseSensitiveTerminal(paraterminal)), cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(#)), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgCaseSensitiveTerminal(paraterminal)), cfgSlot, cfgFoldUnder(cfgNonterminal(paraterminalElements)), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgCaseSensitiveTerminal(chooser)), cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(#)), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgCaseSensitiveTerminal(chooser)), cfgSlot, cfgNonterminal(ID), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgCaseSensitiveTerminal(lexer)), cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(#)), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgCaseSensitiveTerminal(lexer)), cfgSlot, cfgNonterminal(ID), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgCaseSensitiveTerminal(parser)), cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(#)), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgCaseSensitiveTerminal(parser)), cfgSlot, cfgNonterminal(ID), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgCaseSensitiveTerminal(interpreter)), cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(#)), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgCaseSensitiveTerminal(interpreter)), cfgSlot, cfgNonterminal(ID), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgCaseSensitiveTerminal(support)), cfgSlot, cfgNonterminal(cfgNative), cfgSlot, cfgNonterminal(cfgNative), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgCaseSensitiveTerminal(generate)), cfgSlot, cfgNonterminal(ID), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgCaseSensitiveTerminal(generate)), cfgSlot, cfgNonterminal(__int32), cfgSlot, cfgNonterminal(ID), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgCaseSensitiveTerminal(start)), cfgSlot, cfgNonterminal(cfgNonterminal), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgCaseSensitiveTerminal(start)), cfgSlot, cfgNonterminal(trRelation), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgCaseSensitiveTerminal(configuration)), cfgSlot, cfgNonterminal(trRelation), cfgSlot, cfgNonterminal(configurationElements), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgCaseSensitiveTerminal(terminal)), cfgSlot, cfgNonterminal(trRelation), cfgSlot, cfgNonterminal(trTerm), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgCaseSensitiveTerminal(terminal)), cfgSlot, cfgNonterminal(trRelation), cfgSlot, cfgNonterminal(trTerm), cfgSlot, cfgFoldUnder(cfgNonterminal(trTermsTail)), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgCaseSensitiveTerminal(clear)), cfgSlot, cfgCaseSensitiveTerminal(allRules), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgCaseSensitiveTerminal(clear)), cfgSlot, cfgCaseSensitiveTerminal(cfgRules), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgCaseSensitiveTerminal(clear)), cfgSlot, cfgCaseSensitiveTerminal(chooseRules), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgCaseSensitiveTerminal(clear)), cfgSlot, cfgCaseSensitiveTerminal(trRules), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgCaseSensitiveTerminal(trace)), cfgSlot, cfgNonterminal(__int32), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgCaseSensitiveTerminal(print)), cfgSlot, cfgFoldUnder(cfgNonterminal(displayElement)), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgCaseSensitiveTerminal(printraw)), cfgSlot, cfgFoldUnder(cfgNonterminal(displayElement)), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgCaseSensitiveTerminal(printlatex)), cfgSlot, cfgFoldUnder(cfgNonterminal(displayElement)), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgCaseSensitiveTerminal(write)), cfgSlot, cfgNonterminal(file), cfgSlot, cfgFoldUnder(cfgNonterminal(displayElement)), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgCaseSensitiveTerminal(writelatex)), cfgSlot, cfgNonterminal(file), cfgSlot, cfgFoldUnder(cfgNonterminal(displayElement)), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgCaseSensitiveTerminal(show)), cfgSlot, cfgFoldUnder(cfgNonterminal(displayElement)), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgCaseSensitiveTerminal(prompt)), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgCaseSensitiveTerminal(prompt)), cfgSlot, cfgBuiltinTerminal(STRING_DQ), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgCaseSensitiveTerminal(try)), cfgSlot, cfgNonterminal(file), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgCaseSensitiveTerminal(try)), cfgSlot, cfgNonterminal(file), cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(=)), cfgSlot, cfgNonterminal(trTopTuple), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgCaseSensitiveTerminal(try)), cfgSlot, cfgNonterminal(trTopTuple), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgCaseSensitiveTerminal(try)), cfgSlot, cfgNonterminal(trTopTuple), cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(=)), cfgSlot, cfgNonterminal(trTopTuple), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgCaseSensitiveTerminal(sppfBreakCycles)), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgCaseSensitiveTerminal(sppfBreakCycles)), cfgSlot, cfgFoldUnder(cfgNonterminal(cycleModes)), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgCaseSensitiveTerminal(sppfBreakCyclesRelation)), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgCaseSensitiveTerminal(nop)), cfgSlot))), cfgRule(cfgLHS(cycleModes), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgFoldUnder(cfgNonterminal(cycleMode)), cfgSlot), cfgSeq(cfgSlot, cfgFoldUnder(cfgNonterminal(cycleMode)), cfgSlot, cfgFoldUnder(cfgNonterminal(cycleModes)), cfgSlot))), cfgRule(cfgLHS(cycleMode), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgCaseSensitiveTerminal(trace), cfgSlot), cfgSeq(cfgSlot, cfgCaseSensitiveTerminal(statistics), cfgSlot), cfgSeq(cfgSlot, cfgCaseSensitiveTerminal(counts), cfgSlot))), cfgRule(cfgLHS(file), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgBuiltinTerminal(STRING_PLAIN_SQ), cfgSlot))), cfgRule(cfgLHS(whiteSpaceElements), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgNonterminal(whiteSpaceElement), cfgSlot), cfgSeq(cfgSlot, cfgNonterminal(whiteSpaceElement), cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(\\,)), cfgSlot, cfgFoldUnder(cfgNonterminal(whiteSpaceElements)), cfgSlot))), cfgRule(cfgLHS(whiteSpaceElement), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgFoldOver(cfgNonterminal(cfgNonterminal)), cfgSlot), cfgSeq(cfgSlot, cfgFoldOver(cfgNonterminal(cfgBuiltinTerminal)), cfgSlot))), cfgRule(cfgLHS(configurationElements), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgNonterminal(configurationElement), cfgSlot), cfgSeq(cfgSlot, cfgNonterminal(configurationElement), cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(\\,)), cfgSlot, cfgFoldUnder(cfgNonterminal(configurationElements)), cfgSlot))), cfgRule(cfgLHS(configurationElement), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgNonterminal(ID), cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(\\:)), cfgSlot, cfgNonterminal(ID), cfgSlot))), cfgRule(cfgLHS(paraterminalElements), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgNonterminal(paraterminalElement), cfgSlot), cfgSeq(cfgSlot, cfgNonterminal(paraterminalElement), cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(\\,)), cfgSlot, cfgFoldUnder(cfgNonterminal(paraterminalElements)), cfgSlot))), cfgRule(cfgLHS(paraterminalElement), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgFoldOver(cfgNonterminal(cfgNonterminal)), cfgSlot))), cfgRule(cfgLHS(displayElement), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgCaseSensitiveTerminal(version), cfgSlot), cfgSeq(cfgSlot, cfgCaseSensitiveTerminal(term), cfgSlot, cfgNonterminal(trTerm), cfgSlot), cfgSeq(cfgSlot, cfgCaseSensitiveTerminal(latex), cfgSlot), cfgSeq(cfgSlot, cfgNonterminal(file), cfgSlot), cfgSeq(cfgSlot, cfgCaseSensitiveTerminal(script), cfgSlot), cfgSeq(cfgSlot, cfgCaseSensitiveTerminal(scriptDerivation), cfgSlot), cfgSeq(cfgSlot, cfgCaseSensitiveTerminal(allRules), cfgSlot), cfgSeq(cfgSlot, cfgCaseSensitiveTerminal(cfgRules), cfgSlot), cfgSeq(cfgSlot, cfgCaseSensitiveTerminal(chooseRules), cfgSlot), cfgSeq(cfgSlot, cfgCaseSensitiveTerminal(trRules), cfgSlot), cfgSeq(cfgSlot, cfgCaseSensitiveTerminal(gdg), cfgSlot), cfgSeq(cfgSlot, cfgCaseSensitiveTerminal(lexer), cfgSlot), cfgSeq(cfgSlot, cfgCaseSensitiveTerminal(parser), cfgSlot), cfgSeq(cfgSlot, cfgCaseSensitiveTerminal(interpreter), cfgSlot), cfgSeq(cfgSlot, cfgCaseSensitiveTerminal(input), cfgSlot), cfgSeq(cfgSlot, cfgCaseSensitiveTerminal(twe), cfgSlot), cfgSeq(cfgSlot, cfgCaseSensitiveTerminal(lexicalisations), cfgSlot), cfgSeq(cfgSlot, cfgCaseSensitiveTerminal(paraterminals), cfgSlot), cfgSeq(cfgSlot, cfgCaseSensitiveTerminal(parasentences), cfgSlot), cfgSeq(cfgSlot, cfgCaseSensitiveTerminal(gss), cfgSlot), cfgSeq(cfgSlot, cfgCaseSensitiveTerminal(sppf), cfgSlot), cfgSeq(cfgSlot, cfgCaseSensitiveTerminal(bsr), cfgSlot), cfgSeq(cfgSlot, cfgCaseSensitiveTerminal(derivation), cfgSlot), cfgSeq(cfgSlot, cfgCaseSensitiveTerminal(derivationTerm), cfgSlot), cfgSeq(cfgSlot, cfgCaseSensitiveTerminal(derivationIndexedTerm), cfgSlot), cfgSeq(cfgSlot, cfgCaseSensitiveTerminal(interpretation), cfgSlot), cfgSeq(cfgSlot, cfgCaseSensitiveTerminal(statistics), cfgSlot), cfgSeq(cfgSlot, cfgNonterminal(__string), cfgSlot), cfgSeq(cfgSlot, cfgCaseSensitiveTerminal(sppfCyclicNodes), cfgSlot), cfgSeq(cfgSlot, cfgCaseSensitiveTerminal(sppfAmbiguousNodes), cfgSlot))), cfgRule(cfgLHS(__bool), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgCaseSensitiveTerminal(true), cfgSlot), cfgSeq(cfgSlot, cfgCaseSensitiveTerminal(false), cfgSlot))), cfgRule(cfgLHS(__char), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgBuiltinTerminal(CHAR_BQ), cfgSlot))), cfgRule(cfgLHS(__intAP), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgBuiltinTerminal(AP_INTEGER), cfgSlot))), cfgRule(cfgLHS(__int32), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgBuiltinTerminal(SIGNED_INTEGER), cfgSlot))), cfgRule(cfgLHS(__realAP), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgBuiltinTerminal(AP_REAL), cfgSlot))), cfgRule(cfgLHS(__real64), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgBuiltinTerminal(SIGNED_REAL), cfgSlot))), cfgRule(cfgLHS(__string), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgBuiltinTerminal(STRING_DQ), cfgSlot))), cfgRule(cfgLHS(ID), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgFoldOver(cfgBuiltinTerminal(ID)), cfgSlot))), cfgRule(cfgLHS(IDSTAR), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgNonterminal(ID), cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(*)), cfgSlot))), cfgRule(cfgLHS(ID_ATTRIBUTE), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgBuiltinTerminal(ID), cfgSlot, cfgFoldUnder(cfgCaseSensitiveTerminal(.)), cfgSlot, cfgBuiltinTerminal(ID), cfgSlot))), cfgRule(cfgLHS(STRING_DQ), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgFoldOver(cfgBuiltinTerminal(STRING_DQ)), cfgSlot))), cfgRule(cfgLHS(STRING_DOLLAR), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgFoldOver(cfgBuiltinTerminal(STRING_DOLLAR)), cfgSlot))), cfgRule(cfgLHS(STRING_SHRIEK_SHRIEK), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgFoldOver(cfgBuiltinTerminal(STRING_SHRIEK_SHRIEK)), cfgSlot))), cfgRule(cfgLHS(STRING_PLAIN_SQ), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgFoldOver(cfgBuiltinTerminal(STRING_PLAIN_SQ)), cfgSlot))), cfgRule(cfgLHS(CHAR_BQ), cfgAttributeDeclarations, cfgAlts(cfgSeq(cfgSlot, cfgFoldOver(cfgBuiltinTerminal(CHAR_BQ)), cfgSlot))))";
  ...
  private boolean disableChoosers = false; // Can be replaced by currentChooser = null in due course;
  ...
  private void directiveAction(int term) {
    ...
    case "print":
      processDisplayElements(term, true);
      break;

    case "show":
      processDisplayElements(term, false);
      break;
    ...
    case "clear":
      String argument = iTerms.termSymbolString(iTerms.subterm(term, 0, 0));
      switch (argument) {
      case "all":
      ...
      case "statistics":
        ...
        break;
      default:
        Util.fatal("Unknown !clear argument " + argument + " must be one of all, cfgRules, choseRules, rewriteRules");
      }
      break;
    ...
    case "chooser":
      if (iTerms.termArity(iTerms.subterm(term, 0)) == 0) disableChoosers = true;
      Util.warning("disableChoosers = " + disableChoosers);
      break;
  ...
  private void processDisplayElements(int term, boolean textOnly) {
    PrintStream outputStream = Util.console;
    TermTraverserText outputTraverser = iTerms.plainTextTraverser;
    String displayElement = iTerms.termSymbolString(term);
    ...
    for (int i = 0; i < iTerms.termArity(iTerms.subterm(term, 0)); i++)
      ...
      case "term":
        int printTerm = iTerms.subterm(term, 0, 1);
        outputStream.println(iTerms.toString(printTerm, outputTraverser, indent, depthLimit));
        break;
      ...
      case "lexicalisations":
        ...
        currentLexer.printLexicalisations(textOnly);
        break;
      ...
      default:
        Util.fatal("Unimplemented display element " + displayElement);
      }
  ...
  private CFGElement findCFGElement(int term) {
    ...
    case "cfgCaseSensitiveTerminal":
      return currentCFGRules.findElement(CFGKind.T, iTerms.termSymbolString(iTerms.termChildren(term)[0]));
    case "cfgCaseInsensitiveTerminal":
      return currentCFGRules.findElement(CFGKind.TI, iTerms.termSymbolString(iTerms.termChildren(term)[0]));
