package uk.ac.rhul.cs.csle.art.cfg.gp;
...
import uk.ac.rhul.cs.csle.art.util.tasks.TasksGP;

/* This is a prototype Generalised Predictive parser based on the SLE23 style presentation for experimentation */

public class GPBaseline extends AbstractParser {
  class task {
    CFGNode cfgnode;
    int inputIndex;
    task alt, suc;
