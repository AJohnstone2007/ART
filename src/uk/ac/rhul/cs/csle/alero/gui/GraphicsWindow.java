...
public class GraphicsWindow {
  ...
  // public final AleroTransformer world = new AleroTransformer();
  // final VBox menuStack = new VBox();
  // double cameraDistance;
  //
  // public GraphicsWindow(Stage stage, double x, double y, double width, double height, String title, Double cameraInitialDistance) {
  ...
  //
  // menuStack.getChildren().addAll(Alero.buildMenuBar(), solidView);
  //
  ...
  // final AleroTransformer cameraRotator = new AleroTransformer();
  // final AleroTransformer cameraPanner = new AleroTransformer();
  // final AleroTransformer cameraZflipper = new AleroTransformer();
  //
  ...
  // * correct.
  // *
  // * We want Y to go up, so we could rotate 180 degrees around Z (the axis going into the screen), but then X will go from right to left At the moment I do
  // not
