...
public class ARTGeneratedActions extends AbstractActions {
  public String name() { return "2025-01-22 07:56:49"; }
  ...
  public class ART_C_S extends AbstractAttributeBlock {
    ...
    public void action(int nodeNumber) {
      switch(nodeNumber){
      case 15: System.out.println("Found an a with lexeme " + lexeme());  break;
      case 16: System.out.println("Found a b with lexeme " + lexeme());  break;
      case 17: System.out.println("Found an ID with lexeme " + lexeme());  break;
      }
    }
  }
