...
public class ARTGeneratedActions extends AbstractActions {
  ...
  public class ART_C_STRING_BRACE extends AbstractAttributeBlock {
    ART_C_STRING_BRACE STRING_BRACE = this;
    String v;
    ...
    public void action(int nodeNumber) {
      switch (nodeNumber) {
      case 58:
        STRING_BRACE.v = lexeme().translateEscapes();
        break;
      }
    }
  }
  ...
  public class ART_C_arguments extends AbstractAttributeBlock {
    ...
    LinkedList<String> v;
    ART_C_STRING_BRACE STRING_BRACE1;
    ...
    public void initRHSAttributeBlock(int nodeNumber, int term) {
      switch (nodeNumber) {
      case 62:
        STRING_BRACE1 = new ART_C_STRING_BRACE();
        STRING_BRACE1.term = term;
        break;
      case 63:
    ...
    public void action(int nodeNumber) {
      switch (nodeNumber) {
      case 62:
        arguments.v.add(STRING_BRACE1.v);
  ...
  public class ART_C_define extends AbstractAttributeBlock {
    ...
    public void action(int nodeNumber) {
      ...
      case 71:
        ...
        break;
      case 73:
        currentMacro.put("", STRING_BRACE1.v);
        break;
      }
    }
  }
