...
public void artEvaluate(ARTGLLRDTHandle artElement, ARTGLLAttributeBlock artAttributes, ARTGLLRDTVertex artParent, Boolean artWriteable)  {
  switch (artSPPFNodeLabel(artElement.element)) {
    case ARTL_ART_INTEGER: ARTRD_INTEGER(artElement.element, artParent, artWriteable); break;
    case ARTL_ART_STRING_DQ: ARTRD_STRING_DQ(artElement.element, artParent, artWriteable); break;
    case ARTL_ART_e0: ARTRD_e0(artElement.element, artParent, artWriteable); break;
    case ARTL_ART_e1: ARTRD_e1(artElement.element, artParent, artWriteable); break;
    case ARTL_ART_e2: ARTRD_e2(artElement.element, artParent, artWriteable); break;
    case ARTL_ART_e3: ARTRD_e3(artElement.element, artParent, artWriteable); break;
    case ARTL_ART_e4: ARTRD_e4(artElement.element, artParent, artWriteable); break;
    case ARTL_ART_e5: ARTRD_e5(artElement.element, artParent, artWriteable); break;
    case ARTL_ART_printElements: ARTRD_printElements(artElement.element, artParent, artWriteable); break;
